  ...
  <div className="w-full flex items-center md:p-8 p-6  h-full lg:w-11/12 lg:ml-auto">
    <form className="max-w-lg w-full mx-auto">
      ...
      <div className="mt-12">
        ...
        <p className="text-sm mt-8">You don't have an account? <a href="javascript:void(0);" className="text-healthHub-700 font-semibold hover:underline ml-1">Create account here</a></p>
      </div>
    </form>
  </div>
</div>

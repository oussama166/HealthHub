    ...
    <form className="max-w-lg w-full mx-auto">
      ...
      <div>
        ...
        <div className="relative flex items-center">
          <input name="name" type="text" required className="w-full bg-transparent text-sm border-b border-gray-300 focus:border-healthHub-700 px-2 py-3 outline-none" placeholder="Enter name" />
      ...
      <div className="mt-10">
        ...
        <div className="relative flex items-center">
          <input name="email" type="email" required className="w-full bg-transparent text-sm border-b border-gray-300 focus:border-healthHub-700 px-2 py-3 outline-none" placeholder="Enter email" />
      ...
      <div className="mt-10">
        ...
        <div className="relative flex items-center">
          <input name="password" type="password" required className="w-full bg-transparent text-sm border-b border-gray-300 focus:border-healthHub-700 px-2 py-3 outline-none" placeholder="Enter password" />
      ...
      <div className="flex items-center mt-8">
        ...
        <label htmlFor="remember-me" className="ml-3 block text-sm">
          I accept the <a href="javascript:void(0);" className="text-healthHub-700 font-semibold hover:underline ml-1">Terms and Conditions</a>
        </label>
      </div>
      <div className="mt-12">
        ...
        <p className="text-sm mt-8">Already have an account? <a href="javascript:void(0);" className="text-healthHub-700 font-semibold hover:underline ml-1">Login here</a></p>
      </div>
    </form>
  </div>
</div>

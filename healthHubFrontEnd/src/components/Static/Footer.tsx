      ...
      <div className="mx-auto w-full max-w-screen-xl h-full min-h-[50vh] py-10 flex flex-col justify-between ">
        <div className="flex justify-between">
          <div className="space-y-6">
            <img src="/public/HealthHub.svg" alt="" className="w-20 h-20" />
            <h1 className={"text-3xl font-medium capitalize"}>
              Health
              <span className={"text-blues-700 capitalize font-semibold"}>
                HUB
              </span>
            </h1>{" "}
            <p className="max-w-[60%] w-full font-medium text-neutral-500 ">
          ...
          <div className="w-full grid grid-cols-3 gap-20">
            <div>
              <h2 className="mb-6 text-sm font-semibold text-blues-500 capitalize">
                Support
              </h2>
        ...
        <div>
          ...
          <div className="sm:flex sm:items-center sm:justify-between">
            ...
            <span className="text-sm text-neutral-500 font-medium">
              healthHub 2024 © All Rights Reserved
            </span>
          </div>
        </div>
      </div>
